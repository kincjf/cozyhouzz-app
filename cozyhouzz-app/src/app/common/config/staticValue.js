...
var PARTNETS_MARKETING = [
    "인프라머스", "제로드소프트", "디딤스토리", "CM디자인", "스마트일렉", "RPTech"
];
var PARTNETS_CONTENTS = [
...
var MemberType;
(function (MemberType) {
    MemberType[MemberType["ADMIN"] = 0] = "ADMIN";
    MemberType[MemberType["PUBLIC_MEMBER"] = 1] = "PUBLIC_MEMBER";
    MemberType[MemberType["BUILDING_MEMBER"] = 2] = "BUILDING_MEMBER";
    MemberType[MemberType["LEASE_MEMBER"] = 3] = "LEASE_MEMBER"; // 임대업체
})(MemberType || (MemberType = {}));
var Existed;
(function (Existed) {
    Existed[Existed["NO"] = 0] = "NO";
    Existed[Existed["YES"] = 1] = "YES";
})(Existed || (Existed = {}));
exports.STATIC_VALUE = {
    ...
    ROOM_SETTING_RANGE: ROOM_SETTING_RANGE
};
